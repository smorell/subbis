...
<section id="panel" class="container">
	...
	<div class="row">
		<div class="span12">
			<ul class="breadcrumb">
				<li><a href="<?=site_url('office')?>">Home</a> <span class="divider">/</span></li>
				<li><a href="<?=site_url('office/subbis')?>">Subbis</a> <span class="divider">/</span></li>
				<li class="active">Subbi bearbeiten</li>
			</ul>
		</div>
	</div>
	
	<?=form_open('office/subbi_update',array('class' => 'form-horizontal', 'id' => ''))?>
	
	<div class="row">
		<div class="span12">
			<h5>Subbi bearbeiten</h5>
				...
				<input type="hidden" name="subbis_id" value="<?=$subbi->subbis_id?>">
									...
									<div class="row">
										<div class="span6">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" value="<?=$subbi->first_name?>" class="span4" name="first_name">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" value="<?=$subbi->last_name?>" class="span4" name="last_name">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" value="<?=$subbi->address?>" class="span4" name="address">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls controls-row">
													<input type="text" id="" value="<?=$subbi->zip?>" class="span1" name="zip">
													<input type="text" id="" value="<?=$subbi->city?>" class="span3 pull-right" name="city">
												</div>
								            </div>
										...
										<div class="span5">
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" value="<?=$subbi->phone?>" name="phone">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" value="<?=$subbi->email?>" name="email">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<div class="input-append date" id="dp1" data-date="12.02.1990" data-date-format="dd.mm.yyyy">
													  <input class="span2" size="16" type="text" value="<?=date('d.m.Y',strtotime($subbi->dob))?>" name="dob">
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<label class="radio inline">
													  <input type="radio" id="inlineCheckbox1" name="migra" value="1" name="migra" <?= $subbi->migra  ? "checked":"" ?>> Ja
													</label>
													<label class="radio inline">
													  <input type="radio" id="inlineCheckbox1" name="migra" value="0" name="migra" <?= $subbi->migra  ? "":"checked" ?>> Nein
													</label>
												</div>
								            </div>
									...
									<div class="row">
										<div class="span6">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" value="<?=$subbi->profession?>" class="span4" name="profession">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<select class="span4" name="school" value="<?=$subbi->school?>">
										...
										<div class="span5">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" id="" value="<?=$subbi->driver?>" name="driver">
												</div>
								            </div>
								            ...
								            <div class="control-group">
												...
												<div class="controls">
													<div class="input-prepend input-append">
													  ...
													  <input class="span1" style="text-align:right;" id="appendedPrependedInput" type="text" name="rate" value="<?=$subbi->rate?>">
										...
										<div class="span11">
											<div class="control-group">
												...
												<div class="controls">
													<textarea rows="3" class="span9" name="notes_job"><?=$subbi->notes_job?></textarea>
												</div>
								            </div>
										</div>
												...
												<div class="controls">
													<select class="span4" name="id_promoter">
													  ...
													  <? foreach($promoter as $p):?>
														  <option value="<?=$p->promoter_id?>" <?= $subbi->id_promoter == $p->promoter_id ? "selected='yes'":""?> ><?=sprintf('%04d', $p->promoter_id);?> - <?=$p->first_name?> <?=$p->last_name?></option>
													  <? endforeach?>
													</select>
												</div>
								            </div>
												...
												<div class="controls">
													<select class="span4" name="id_campaign">
													  ...
													  <? foreach($campaign as $c):?>
														  <option value="<?=$c->campaign_id?>" <?= $subbi->id_campaign == $c->campaign_id ? "selected='yes'":""?>><?=sprintf('%04d', $c->campaign_id);?> - <?=$c->name?></option>
													  <? endforeach?>
													</select>
												</div>
								            </div>
									...
									<div class="row">
										<div class="span11">
											<div class="control-group">
												...
												<div class="controls">
													<textarea rows="8" class="span9" name="notes_general"><?=$subbi->notes_general?></textarea>
												</div>
								            </div>
										</div>
									</div>
